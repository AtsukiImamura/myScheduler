...
public class StoneBean  extends ColorAttribute{
	...
	public StoneBean clone(){
		StoneBean colorAttribute = null;
		try {
			colorAttribute =StoneBean.class.newInstance();
